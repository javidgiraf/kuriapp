...
class QRCode
{
  ...
  /**
     ...
     * @return response()
     */
    public function getQrcode($iSize = self::DEFAULT_QR_SIZE, $sECLevel = 'L', $iMargin = 1)
    {
        return self::API_URL . $iSize . 'x' . $iSize . '&cht=qr&chld=' . $sECLevel . '|' . $iMargin . '&chl=' . $this->codeData;
    }
}
